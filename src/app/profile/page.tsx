...
import { User, BookMarked, FileText, Settings, LogOut, Bookmark, Clock, Award } from "lucide-react";
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">{user.user_metadata?.full_name || "Student"}</h1>
