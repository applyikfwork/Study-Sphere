...
import { samplePapers } from "@/lib/data";
import { ClipboardList, Download, FileText, Clock, Star } from "lucide-react";
                ...
                {papers.map((paper) => (
                  <Card key={paper.id} className="card-hover border-0 shadow-lg">
                    <CardHeader>
                      ...
                      <CardTitle className="text-lg mt-4">{paper.type}</CardTitle>
                    </CardHeader>
                    <CardContent>
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button className="flex-1">View Online</Button>
                      </div>
                    </CardContent>
                  </Card>
                ))}
