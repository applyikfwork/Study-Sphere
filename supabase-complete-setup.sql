-- =====================================================
-- COMPLETE SUPABASE SETUP FOR ONLINE SCHOOL PLATFORM
-- =====================================================
...
-- =====================================================
-- STEP 1: CREATE HELPER FUNCTION (PREVENTS RECURSION)
-- =====================================================
...
-- =====================================================
-- STEP 5: CREATE NOTES TABLE WITH ALL COLUMNS
-- =====================================================
...
-- Add missing columns to notes if they don't exist
DO $$ 
BEGIN
...
-- =====================================================
-- STEP 6: CREATE SAMPLE_PAPERS TABLE WITH ALL COLUMNS
-- =====================================================
...
-- Add missing columns to sample_papers if they don't exist
DO $$ 
BEGIN
...
-- =====================================================
-- STEP 7: CREATE PYQS TABLE WITH ALL COLUMNS
-- =====================================================
...
-- Add missing columns to pyqs if they don't exist
DO $$ 
BEGIN
